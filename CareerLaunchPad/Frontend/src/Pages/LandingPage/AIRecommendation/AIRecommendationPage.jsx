...
//                     `https://clp-beta.vercel.app/api/projects/${projectId}/ai-shortlist`,
//                     {},
//                     config
//                 );
      ...
      try {
        ...
        setError(
          err.response?.data?.message ||
            "AI failed to analyze candidates. Try again later.",
        );
      } finally {
        setLoading(false);
      }
  ...
  return (
    <div className="ai-page-wrapper">
      ...
      <div className="ai-container">
        ...
        <div className="ai-header">
          <h1>
            <Sparkles className="ai-icon-main" /> Top Candidates by Gemini AI
          </h1>
          <p>
            We analyzed skills, experience, and project fit to find your best
            matches.
          </p>
        </div>
            ...
            {shortlisted.map((app, index) => (
              <div className="ai-card" key={app._id}>
                ...
                <div className="ai-card-header">
                  <div className="candidate-info">
                    ...
                    <p className="freelancer-role">
                      {app.applicantId.title || "Freelancer"}
                    </p>
                  </div>
                  <div className="match-badge">
                    {app.aiMatchScore || 90}% Match
                ...
                <div className="ai-reason-box">
                  ...
                  <p>
                    {app.aiReason ||
                      "Strong match for your project requirements."}
                  </p>
                </div>
                  ...
                  <div className="stat">
                    ...
                    <span>
                      {app.applicantId.rating
                        ? app.applicantId.rating.toFixed(1)
                        : "New"}
                    </span>
                  </div>
                  <div className="stat">
                    <Trophy size={16} color="#666" />
                    <span>
                      {app.applicantId.completedProjects || 0} Projects
                    </span>
                  </div>
                </div>

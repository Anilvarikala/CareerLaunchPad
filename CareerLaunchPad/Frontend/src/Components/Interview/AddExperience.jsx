...
const AddExperience = () => {
  ...
  const handleChange = (e) => {
    ...
    if (name === "offerReceived") {
      setFormData((prev) => ({
        ...prev,
        offerReceived: value === "yes" ? true : false,
      }));
    } else {
      setFormData((prev) => ({
        ...prev,
    ...
    <div>
      ...
      <div className="add-experience-container">
        ...
        <form className="add-experience-form" onSubmit={handleSubmit}>
          ...
          <p>
            Help your peers by sharing your journey. Fields marked with * are
            required.
          </p>
          ...
          <div className="form-group">
            <label htmlFor="experienceDetails">
              Your Interview Experience (Details) *
            </label>
            <textarea
              ...
              <div className="radio-options">
                <label>
                  <input
                    ...
                    name="offerReceived"
                    value="yes"
                    checked={formData.offerReceived === true}
                    onChange={handleChange}
                  />{" "}
                  Yes
                </label>
                <label>
                  <input
                    ...
                    name="offerReceived"
                    value="no"
                    checked={formData.offerReceived === false}
                    onChange={handleChange}
                  />{" "}
                  No
                </label>

...
//             try {
//                 const { data } = await axios.get('https://clp-beta.vercel.app/api/client/profile/me', config);
//                 setProfile({
...
//         try {
//             await axios.put('https://clp-beta.vercel.app/api/client/profile/me', profile, config);
//             setEditMode(false);
    ...
    const fetchProfile = async () => {
      ...
      try {
        const { data } = await axios.get(
          "https://clp-beta.vercel.app/api/client/profile/me",
          config,
        );
        setProfile({
          firstName: data.firstName || "",

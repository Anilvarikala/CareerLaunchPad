...
const CompletedProjectDetails = () => {
  ...
  if (loading)
    return <div className="completed-page-container">Loading...</div>;
  if (error) return <div className="completed-page-container">{error}</div>;
  if (!project)
    return <div className="completed-page-container">Project not found</div>;
            ...
            <div className="submission-links-section">
              ...
              {submission.repoLink ? (
                ...
                <div className="link-card" style={{ opacity: 0.6 }}>
                  <div className="link-icon">📂</div>
                  <div className="link-details">
                    <strong>No Source Code Link</strong>
                  </div>
                </div>
              )}

...
//         const config = { headers: { Authorization: `Bearer ${token}` } };
//         try {
//             await axios.post('https://clp-beta.vercel.app/api/reviews', {
...
const ClientDashboard = () => {
  ...
  const handleFinishClick = async (projectId) => {
    if (
      !window.confirm(
        "Are you sure you want to accept this work and finish the project?",
      )
    )
      return;
  ...
  const submitReview = async () => {
    ...
    try {
      await axios.post(
        "https://clp-beta.vercel.app/api/reviews",
        {
          projectId: reviewProjectId,
          rating: reviewData.rating,
          comment: reviewData.comment,
              ...
              {selectedProject.submission ? (
                <>
                  <div className="detail-group">
                    <label>Repo:</label>
                    <a
                      href={selectedProject.submission.repoLink}
                      target="_blank"
                      rel="noreferrer"
                    >
                      {selectedProject.submission.repoLink}
                  ...
                  {selectedProject.submission.liveLink && (
                    <div className="detail-group">
                      <label>Live:</label>
                      <a
                        href={selectedProject.submission.liveLink}
                        target="_blank"
                        rel="noreferrer"
                      >
                        {selectedProject.submission.liveLink}
                  ...
                  <div className="detail-group">
                    ...
                    <p className="description-box">
                      {selectedProject.submission.description}
                    </p>
                  </div>
                </>
              ) : (

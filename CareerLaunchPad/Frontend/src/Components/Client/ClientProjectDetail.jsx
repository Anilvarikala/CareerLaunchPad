      ...
      if (foundInSample) {
        ...
        try {
          ...
          const { data } = await axios.get(
            `https://clp-beta.vercel.app/api/projects/client/${id}`,
            config,
          );
          if (data) {
            setProject(data);
    ...
    return (
      <>
        ...
        <div className="project-detail-container error">
          ...
          <button onClick={() => navigate(-1)} className="back-to-projects-btn">
            &larr; Go Back
          </button>
        </div>
      </>
      ...
      <div className="project-detail-container">
        ...
        <div className="project-meta">
          <span className="meta-item">
            Budget: <span className="budget-value">${project.budget}</span>
          </span>
          {project.deadline && (
            <span className="meta-item">
              Deadline:{" "}

...
//         const { data } = await axios.get(`https://clp-beta.vercel.app/api/projects/${id}/applicants`, config);
    ...
    const fetchApplicants = async () => {
      ...
      try {
        ...
        const { data } = await axios.get(
          `https://clp-beta.vercel.app/api/projects/${id}/applicants`,
          config,
        );
  ...
  return (
    <div>
      ...
      <div className="applicants-container">
        ...
        <div
          className="applicants-header-row"
          style={{
            display: "flex",
